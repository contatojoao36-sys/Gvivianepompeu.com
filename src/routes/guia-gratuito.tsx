...
const description =
  "Baixe o guia introdutório que eu gostaria de ter lido antes de começar a pesquisar minha própria família.";
...
function GuiaPage() {
  return (
    <PageShell eyebrow="Guia" title="Trinta lições que mudam o modo como você procura seus antepassados">
      <p className="text-[0.95rem] leading-relaxed text-ink/85">
        Baixe o guia introdutório que eu gostaria de ter lido antes de começar a pesquisar minha
        própria família. São 30 lições práticas para ajudar você a começar sua pesquisa
        genealógica com mais clareza e evitar erros que podem custar muito tempo.
      </p>
